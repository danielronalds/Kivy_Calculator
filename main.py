...
#
#  Learning Resource: https://realpython.com/mobile-app-kivy-python/#laying-out-the-ui
#
#  Kivy Calculator App
#
...
class MainApp(App):
    ...
    def on_button_press(self, instance):
        ...
        if button_text == "C":
            ...
            if current and (
                self_last_was_operator and button_text in self.operators):
                # Don't add two operaters right after each other
                return
